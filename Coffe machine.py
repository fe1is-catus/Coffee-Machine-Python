...
state_before_actions = print(f'The coffee machine has:
...
state_after_actions = print(f'The coffee machine has:
...
if user_action == 'take':
    ...
    after_action_money = default_money - 550
